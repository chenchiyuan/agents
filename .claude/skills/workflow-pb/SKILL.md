...
**版本**: 1.4.0（对应规范 workflow-pb v0.3.0）
**完整规范**: `{角色根}/workflow-pb/workflow-pb.md`（角色根路径解析见「§ 角色文件路径解析」）
**变更历史**: 见 `data/skill-optimization-v1.1.0.md`、`data/skill-optimization-v1.2.0.md`、`data/skill-optimization-v1.3.0.md`、`data/skill-optimization-v1.4.0.md`
